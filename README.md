...
To generate a hash for your password (e.g., "mysecretpassword"):
```bash
python3 -c "from passlib.context import CryptContext; pwd_context = CryptContext(schemes=['bcrypt'], deprecated='auto'); print(pwd_context.hash('mysecretpassword'))"
```

Copy the output (starting with `$2b$...`) into your `.env` file:

```env
SECRET_KEY=your-super-secret-key-minimum-32-characters
ADMIN_USERNAME=your-username
ADMIN_PASSWORD=$2b$12$YourGeneratedHashHere...
```
...
| `ADMIN_PASSWORD` | Login password (Bcrypt Hash) | `$2b$...` (hash for `changeme123`) |

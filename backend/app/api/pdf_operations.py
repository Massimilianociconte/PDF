...
async def upload_pdf(
    ...
    # Save file using streaming to prevent memory issues with large files
    try:
        total_size = 0
        ...
        async with aiofiles.open(file_path, 'wb') as f:
            while True:
                ...
                if total_size > settings.max_file_size:
                    ...
                    # We need to rely on the finally block or OS to clean up the open file,
                    # but context manager handles closing 'f'.
                    # We should remove the partial file.

...
export default function FileUploader({ onFileUploaded }) {
  ...
  return (
    <div>
      ...
      >
        ...
        <div aria-live="polite">
          {uploading ? (
            ...
            <div className="space-y-3" role="status">
              <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center mx-auto" aria-hidden="true">
      ...
      {error && (
        <div className="mt-4 bg-red-50 text-red-600 px-4 py-3 rounded-lg text-sm flex items-center" role="alert">

...
import { Merge, GripVertical, Plus, Minus, Check } from 'lucide-react'
              ...
              >
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    disabled={index === 0}
                    aria-label={`Move ${file.originalName || file.filename} up`}
                  ...
                  <button
                    ...
                    aria-label={`Move ${file.originalName || file.filename} down`}
                    className="p-1 hover:bg-gray-200 rounded disabled:opacity-30"
                  >
                    ↓
                  </button>

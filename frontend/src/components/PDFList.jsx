          ...
          >
            ...
            <div className="flex items-center space-x-2 ml-2">
              <button
                ...
                className="p-2 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 outline-none"
                title="Download"
              ...
              <button
                ...
                className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-red-500 outline-none"
                title="Delete"
